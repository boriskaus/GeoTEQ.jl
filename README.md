...
The julia package closely follows the python package, which is described in detail [here](https://geoteqpy.readthedocs.io/en/latest/). 
...
2. The resulting median plane surface is saved as `*.vts` file. 
